...
import { createTestLayouts } from "./workspace-layouts.js";
...
type TestObject = Omit<WorldObject, "floorId" | "variantId"> & { variantId?: string };


const studioObjects = objectsForFloor("floor-studio", [
  { id: "object-commons-rug", assetId: "rug-woven", x: 144, y: 128, rotation: 0, variantId: "oak" },
  { id: "object-product-rug", assetId: "rug-round", x: 128, y: 720, rotation: 0, variantId: "walnut" },
  ...floorTiles("studio-entry-step", "floor-stone-tiles", "limestone", 736, 928, 1, 1),
  ...floorTiles("studio-courtyard", "floor-stone-tiles", "limestone", 640, 992, 7, 3),
  ...floorTiles("studio-east-lawn", "floor-grass", "lawn", 1568, 80, 4, 13),
  ...floorTiles("studio-south-lawn", "floor-grass", "lawn", 1088, 944, 11, 4),
  ...
  { id: "object-falling-blocks", assetId: "equipment-falling-blocks", x: 1088, y: 576, rotation: 0, label: "Falling Blocks" },
  { id: "object-tic-tac-toe", assetId: "equipment-tic-tac-toe", x: 1296, y: 576, rotation: 0, label: "Tic-Tac-Toe" },
  { id: "object-chess", assetId: "equipment-chess", x: 1360, y: 736, rotation: 0, label: "Chess" },
...
const rooftopObjects = objectsForFloor("floor-rooftop", [
  { id: "object-garden-mat", assetId: "rug-tatami", x: 256, y: 208, rotation: 0, variantId: "matcha" },
  ...floorTiles("rooftop-deck", "floor-decking", "cedar", 512, 752, 11, 3),
  ...floorTiles("rooftop-east-garden", "floor-grass", "lawn", 1232, 80, 3, 10),
...
export function createTestWorld(officeId: string): TestWorld {
  const floors: Floor[] = [
    {
      id: "floor-studio",
      officeId,
  ...
  return { floors, layouts: createTestLayouts(floors, objects) };
}

function objectsForFloor(floorId: string, objects: TestObject[]): WorldObject[] {
...
function floorTiles(
  ...
  return Array.from({ length: columns * rows }, (_, index) => {
    ...
    return {
      ...
      assetId,
      x: x + column * size.width * ASSET_RASTER_SIZE,
      y: y + row * size.height * ASSET_RASTER_SIZE,
      rotation,
      variantId,
    };
  });
