import { getPlacedAssetInteractions, rotateDirection } from "@workhard/shared";
import type { FacingDirection, FloorLayout, Position, Rect, WorldObject } from "@workhard/shared";
